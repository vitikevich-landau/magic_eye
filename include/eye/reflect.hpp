...
// --- Платформа: какая ABI (деманглер + раскладка vtable) ---------------------
#include "detail/abi.hpp"   // EYE_ITANIUM_ABI (+ <cxxabi.h> на Itanium)
...
#include "detail/model_types.hpp"  // FieldInfo/Passport/VtableSite/… (словарь данных)
...
// Структуры данных модели (FieldInfo, Passport, VtableSite, BaseInfo,
// VectorInfo, FieldRef, OpaqueSpan, ObjectModel) вынесены в
// detail/model_types.hpp — их рисует eye/render.hpp, включая ТОЛЬКО тот файл.
